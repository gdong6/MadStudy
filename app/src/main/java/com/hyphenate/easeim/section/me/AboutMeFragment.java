...
import com.hyphenate.easeim.section.me.activity.mapActivity;
...
public class AboutMeFragment extends BaseInitFragment implements View.OnClickListener {
    ...
    private ArrowItemView arrowItem1;
    @Override
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        nickName_view.setText( DemoHelper.getInstance().getCurrentUser());
        arrowItem1=findViewById(R.id.arrowItem1);
    }
    ...
    protected void initListener() {
        ...
        arrowItem1.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.item_common_set:
                ...
                break;
            case R.id.arrowItem1:
                mapActivity.actionStart(mContext);
    ...
    protected void addLiveDataObserver() {
        LiveDataBus.get().with(DemoConstant.AVATAR_CHANGE, EaseEvent.class).observe(this, event -> {
            if (event != null) {
                Glide.with(mContext).load(event.message).placeholder(R.drawable.ic_chat).into(avatar);
                if(userInfo != null){
        ...
        LiveDataBus.get().with(DemoConstant.NICK_NAME_CHANGE, EaseEvent.class).observe(this, event -> {
            if (event != null) {
                ...
                userId_view.setText(EMClient.getInstance().getCurrentUser());
                if(userInfo != null){
