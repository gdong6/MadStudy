    ...
    public boolean onItemLongClick(View view, int position) {
        ...
        menu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_group_add_admin :
                        addToAdmins(username);
                        break;
                    case R.id.action_group_remove_admin :
                        removeFromAdmins(username);
                        break;
                    case R.id.action_group_transfer_owner :
                        transferOwner(username);
                        break;
                    case R.id.action_group_remove_member :
                        ...
                        break;
                    case R.id.action_group_add_black :
                        addToBlack(username);
                        break;
                    case R.id.action_group_remove_black :
                        removeFromBlacks(username);
                        break;
                    case R.id.action_group_mute :
                        AddToMuteMembers(username);
                        break;
                    case R.id.action_group_unmute :
