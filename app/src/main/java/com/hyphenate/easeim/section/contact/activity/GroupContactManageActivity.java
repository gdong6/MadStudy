...
import com.hyphenate.notes.Activity.NoteMainActivity;
...
public class GroupContactManageActivity extends BaseInitActivity implements EaseTitleBar.OnBackPressListener, EaseTitleBar.OnRightClickListener, View.OnClickListener {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        mTvContent = findViewById(R.id.tv_content);
         findViewById(R.id.tv_node).setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View v) {
                 Intent intent=new Intent(GroupContactManageActivity.this, NoteMainActivity.class);
